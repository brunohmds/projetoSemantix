Este repositório contém o projeto final do treinamento de Big Data Engineer, promovido pela Semantix


O conteúdo programático do curso consistiu em seis tópicos, distribuídos ao longo de 12 semanas, como pode ser visto abaixo:


Big Data Foundations (Semanas 1, 2 e 3):
...
Spark - Big Data Processing (Semanas 9, 10 e 11)
...
Projeto Final (Semana 12)
- Elaboração do projeto final, tema deste repositório
